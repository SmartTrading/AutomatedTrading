...
class KernelRidgeARD:
    ...
    def __init__(self,lambda_ard,lambda_reg,p):
        ...
        self.p = p
        # kernel parameter
        self.lambda_ard = lambda_ard.reshape((p,1))
    ...
    def fit(self,training_X,training_Y):
        ...
        returnlist = {}
        returnlist.update({'kernel matrix':self.kernelmatrix})
        returnlist.update({'kernel ridge design matrix':self.kernelridgeDesign})
        returnlist.update({'fitted weights':self.fittedweight})
        return returnlist    
    ...
    def setARDkernel(self,lambda_ard):
        self.lambda_ard = lambda_ard.reshape((self.p,1))
