...
with open(confiFilePath,'a') as confiFile:
    ...
    confiFile.write('SGD improvements in mse:' + str(np.abs(testScores_SGDHP.get('mse')[0]-testScores_fixedHP.get('mse')[0])/testScores_fixedHP.get('mse')[0] ) + '\n')
    confiFile.write('SGD improvements in mae:' + str(np.abs(testScores_SGDHP.get('mae')[0]-testScores_fixedHP.get('mae')[0])/testScores_fixedHP.get('mae')[0] ) + '\n')
    confiFile.write('SGD improvements in mpe:' + str(np.abs(testScores_SGDHP.get('mpe')[0]-testScores_fixedHP.get('mpe')[0])/testScores_fixedHP.get('mpe')[0] ) + '\n')
